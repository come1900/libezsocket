...
/*inline */int ez_megaeye_GetMonitorPlayUrl(
    const char *pHost    , /* ��·url��Э��://ip:port�����磺rtsp://192.168.5.66:554                 */
    const char *pPort    , /* ��·url��Э��://ip:port�����磺rtsp://192.168.5.66:554                 */
    const char *pAccount , /* �˺š��û���                                                           */
    const char *pPasswd  , /* ����                                                                   */
    const char *pChannel , /* ͨ����, ID��                                                           */
    char       *pPlayUrl   /* �������ͣ�������Ϊ0����subtype=0����������Ϊ1����subtype=1�����Դ����� */
)
{
    int iret = 9999;
    ez_socket_t sockfd = INVALID_SOCKET;
...
int ez_getStreamPlayUrl(
    const int iType      , /* �����ͣ����Ŷ��壺1-��ý��  2-����IPC 3-��IPC  ezDef_StreamType_     */
    const char *pUrl     , /* ��·url��Э��://ip:port�����磺rtsp://192.168.5.66:554                 */
    const char *pAccount , /* �˺š��û���                                                           */
    const char *pPasswd  , /* ����                                                                   */
    const char *pChannel , /* ͨ����, ID��                                                           */
    const char *pSubtype , /* �������ͣ�������Ϊ0����subtype=0����������Ϊ1����subtype=1�����Դ����� */
    char       *pPlayUrl , /* �������ͣ�������Ϊ0����subtype=0����������Ϊ1����subtype=1�����Դ����� */
...
)
{
    ...
    char *__phost = NULL;
    char *__pport = NULL;//��ֹ����ֱ����parsed_url->port �ҵ�
    int __port_http = 0;
    int __port_rtsp = 0;
    ...
    if (pUrl && *pUrl!='\0')
    {
        ...
        do
        {
            ...
            {
                // ��ֹ��pss://192.168.5.66:18088?http=80&rtsp=554
